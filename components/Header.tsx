...
const Header: React.FC<HeaderProps> = ({ currentPage, userRole, navigateTo, handleLogout, onChangePassword, onGmailSettings }) => {
    return (
        <header className="mb-6">
            ...
            <div className="flex items-center justify-end gap-3 mt-4">
                ...
                {userRole === UserRole.Teacher && onGmailSettings && (
                    <GlassButton
                        onClick={onGmailSettings}
                        variant="default"
                        size="md"
                    >
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
